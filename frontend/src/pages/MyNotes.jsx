...
const MyNotes = () => {
  ...
  const fetchNotes = async () => {
    ...
    const { data } = await axios.get("https://notespot-backend-cqdi.onrender.com/api/notes", config);
    setNotes(data);
  };
  ...
  const handleDeleteAll = async () => {
    ...
    await axios.delete("https://notespot-backend-cqdi.onrender.com/api/notes", config);
